...
@DatasetReader.register("debias_finetuning_transformer_e2e")
class FineTuningNLIReaderTransformer(DatasetReader):
    """
    ...
    def text_to_instance(self,  # type: ignore
        ...
        fields: Dict[str, Field] = {
            'tokens': TextField(sentence1_toks + sentence2_toks[1:], self._token_indexers),
            'bias_tokens': TextField(sentence1_toks, self._token_indexers)
        }
